...
if __name__ == '__main__':
    tester = Tester('models_archive/model_satv2.pt', model.GNNSat_V2)
    #tester = Tester('models/model_10.pt', model.GNNSat_V2)
        ...
        with MUSX(formula, solver=solver, verbosity=verbose) as musx:
            if gnn:
                if False:
                    ...
                    mus = musx.compute(tester.test(cnf_data, cluster_coeff=False), coeff=1)
            else:
